...
export const ALTERNATE = (path) => [
  ...
  {
    href: process.env.SITE_URL + '/it-it' + path,
    hreflang: 'it-it',
  },
  {
    href: process.env.SITE_URL + '/pt-br' + path,
    hreflang: 'pt-br',
  },
  {
    href: process.env.SITE_URL + '/es-es' + path,
    hreflang: 'es-es',
  },
  {
    href: process.env.SITE_URL + '/de-de' + path,
    hreflang: 'de-de',
  },
  {
    href: process.env.SITE_URL + '/fr-fr' + path,
    hreflang: 'fr-fr',
  },
  {
    href: process.env.SITE_URL + '/es-es' + path,
  ...
  {
    href: process.env.SITE_URL + '/ro' + path,
    hreflang: 'ro',
  },
  {
    href: process.env.SITE_URL + '/pl-pl' + path,
    hreflang: 'pl-pl',
  },
  {
    href: process.env.SITE_URL + '/cs-cz' + path,
    hreflang: 'cs-cz',
  },
  {
    href: process.env.SITE_URL + '/sv-se' + path,
    hreflang: 'sv-se',
  },
  {
    href: process.env.SITE_URL + '/et-ee' + path,
    hreflang: 'et-ee',
  },
  {
    href: process.env.SITE_URL + '/ja-jp' + path,
    hreflang: 'ja-jp',
  },
]
